...
# Train model on-the-fly if model.pkl doesn't exist
@st.cache_resource
def load_model():
    ...
    # Train from scratch using the CSV
...
st.caption("⚠️ This tool is for educational purposes only and is not a substitute for medical advice.")import streamlit as st
import numpy as np
import pandas as pd
import pickle
import os
